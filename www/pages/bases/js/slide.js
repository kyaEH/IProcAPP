$(function() {
   ...
   function slideEffect() {
      var timer = setInterval(function() {
         ...
         $("." + rdH + "." + rdW).each(function() {
            $(this).delay(500).slideUp(0, function() {
               $(this).remove();
            });
         });
      }, 100);
   ...
   $(".submitkey").click(function() {
      ...
      if(key=="hello world"){
         ...
         $(".slide").fadeOut(200);
         $(".slide:last-child", ".hack-slider").addClass("hack");
         $('.slide').html("The key worked... The door opened... <p>Welcome, master</p>");
         $(".slide.hack").fadeIn(200);
         $(".hack-slider").height($(".slide.hack").height());
         slideEffect();
         $(".arrows").remove();
         setTimeout(function(){ 
            ...
            //$(".slide").fadeOut(200);
            setTimeout(function(){ 
               localStorage.setItem("chapter1", true);
         ...
         $('#key').val('');
         $('#key').attr("placeholder", "Wrong key.");
      }
   });
